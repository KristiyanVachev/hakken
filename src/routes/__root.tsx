  ...
  head: () => ({
    meta: [
      ...
      { title: "Hakken — God Save the Streak" },
      {
        name: "description",
        content:
          "A self-taught rebellion. Kill the owl, keep the habit. Learn Japanese from the media you already love.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Anton&family=Archivo+Black&family=Bungee&family=Rubik+Mono+One&family=Special+Elite&family=Bebas+Neue&display=swap",
      },
    ],
  }),
